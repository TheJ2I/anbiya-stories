// C:/imad/dev/anbiya-stories/app/stories/youssef/chapter-5.tsx
...
export default function Chapter5Screen() {
  ...
  const scenes: Scene[] = t.chapter5.storySegments.map((segment, index) => ({
    text: segment.text,
    image: chapter5Images[index],
  }));
  ...
  const handleFinalContinue = () => {
    if (isLastScene && !isAnimating.value) {
      console.log('Navigate to Chapter 6');
      // This line is now active
      router.push(`/stories/youssef/chapter-6?lang=${language}`);
    }
  };
