// C:/imad/dev/anbiya-stories/app/stories/youssef/chapter-6.tsx
...
export default function Chapter6Screen() {
  ...
  const scenes: Scene[] = t.chapter6.storySegments.map((segment, index) => ({
    text: segment.text,
    image: chapter6Images[index],
  }));
