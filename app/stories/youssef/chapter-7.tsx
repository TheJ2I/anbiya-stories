// app/stories/youssef/chapter-7.tsx
...
export default function Chapter7Screen() {
    ...
    // N'oubliez pas d'ajouter vos images chapter7_scene1.png, etc. dans le dossier assets
    const chapterImages = [
    ...
    const scenes: Scene[] = t.chapter7.storySegments.map((segment, index) => ({
        text: segment.text,
    ...
    const handleFinalContinue = () => {
        if (isLastScene && !isAnimating.value) {
            console.log('Navigate to Chapter 8');
            // Décommentez ceci une fois le chapitre 8 créé
            router.push(`/stories/youssef/chapter-8?lang=${language}`);
        }
    };
