// C:/imad/dev/anbiya-stories/app/stories/youssef/chapter-4.tsx
...
export default function Chapter4Screen() {
  ...
  const scenes: Scene[] = t.chapter4.storySegments.map((segment, index) => ({
    text: segment.text,
    image: chapter4Images[index],
  }));
  ...
  const handleFinalContinue = () => {
    if (isLastScene && !isAnimating.value) {
      console.log('Navigate to Chapter 5');
      // This line is now active
      router.push(`/stories/youssef/chapter-5?lang=${language}`);
    }
  };
